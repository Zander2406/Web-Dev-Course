            ...
            <div className="col1 flex justify-center items-center flex-col text-gray-900">
                ...
                <h1 className='font-bold text-4xl'>Create your Bittree</h1>
                    <div className="item">
                        ...
                        <div className='mx-4'>
                            <input value={handle || ""} onChange={e=>{sethandle(e.target.value)}} className='px-4 py-2 my-2 focus:outline-pink-500 rounded-full bg-white' type="text" placeholder='Choose a Handle' />
                        </div>
                    </div>
                    ...
                    <div className="item">
                        ...
                        { links && links.map((item, index) => {
                            ...
                            <button onClick={() => addLink()} className='py-2 mx-2 bg-slate-900 text-white font-bold rounded-3xl p-5'> + Add Link </button>
                    </div>
                    ...
                    <div className="item">
                        ...
                        <div className='mx-4 flex flex-col'>
                            ...
                            <button disabled={pic == "" || handle=="" || links[0].linktext==""} onClick={()=>{submitLinks()}} className='disabled:bg-slate-500 py-2 mx-2 bg-slate-900 text-white font-bold rounded-3xl p-5 w-fit my-5'> Create your BitTree </button>
                        </div>
                    </div>
                </div>
            </div>
